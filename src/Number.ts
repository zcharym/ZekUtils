export default abstract class ZNumber {
    /**
     * 精确浮点数展示结果
     * @param n 需要格式化的浮点数
     * @param fixed 精确位数
     */
    public static formatFloatNum(n: number, fixed: number = 10): number {
     ...
     */
    public static addFloatNum(num1: number, num2: number): number {
     ...
     */
    public static to64bitFloat(n: number): string {
        let i, result = "";
